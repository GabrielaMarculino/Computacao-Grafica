// g++ -o 2.33-3 2.33-3.cpp -lglut -lGL -lGLU -lm
#include <cstdlib>
#include <cmath>
#include <iostream>
...
// Globals.
static float R = 15.0; // Radius of hemisphere.
static int p = 20; // Number of longitudinal slices.
static int q = 10; // Number of latitudinal slices.
static float Xangle = 20.0, Yangle = 40.0, Zangle = 0.0; // Angles to rotate hemisphere.
...
void drawScene(void)
{
    ...
    for (t = -5 * PI; t <= PI; t += PI / 20.0) {
        glVertex3f(R * cos(t)+30, R * sin(t), t - 20.0);
        glVertex3f(R * cos(t)+32, R * sin(t), t - 20.0);
    }
    glEnd();
