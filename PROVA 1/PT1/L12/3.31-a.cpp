// g++ -o 2.31-a 2.31-a.cpp -lglut -lGL -lGLU -lm
#include <cstdlib>
#include <cmath>
#include <iostream>
...
void drawScene(void)
{
    ...
    for (j = 0; j < 2; j++)
    {
        ...
        for (i = 0; i <= p; i++)
        {
            glVertex3f(R * cos((float)(j + 1) / 4 * PI / 2.0) * cos(2.0 * (float)i / p * PI),
                R * sin((float)(j + 1) / 4 * PI / 2.0),
                R * cos((float)(j + 1) / 4 * PI / 2.0) * sin(2.0 * (float)i / p * PI));
            glVertex3f(R * cos((float)j / 4 * PI / 2.0) * cos(2.0 * (float)i / p * PI),
                R * sin((float)j / 4 * PI / 2.0),
                R * cos((float)j / 4 * PI / 2.0) * sin(2.0 * (float)i / p * PI));
        }
        glEnd();
    }
