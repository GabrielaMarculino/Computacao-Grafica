//a detecção de colisão é feita na função asteroidCraftCollision, checando se o centro da base da nave está em (x, 0, z) e está alinhado num ângulo a para a direção -z, é utilizado dois for, em j e i, para acessar cada asteroide da matriz, e chamando a função checkSpheresIntersection para checar de duas esferas colidem, a esfera 1 sendo a nave e a esfera 2 sendo o asteroide acessado no momento, caso o raio entre ela se intercepta, a função retorna verdadeiro, barrando o movimento da nave
